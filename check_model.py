...
def save_feature(extractor, data_loader, save_root,device):
    idx = 0
    for batch in tqdm(data_loader):
        ...
        with torch.no_grad():
            feature_list = extractor.get_feature_from_input(image)
...
def main():
    ...
    save_feature(extract,data_loader_train,train_f_path,device)
    save_feature(extract, data_loader_val, val_f_path, device)
